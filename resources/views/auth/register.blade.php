                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('MI') ? ' has-error' : '' }}">
                            <label for="MI" class="col-md-4 control-label">Middle Initial</label>

                            <div class="col-md-6">
                                <input id="mi" type="text" class="form-control" name="MI" value="{{ old('mi') }}" maxlength="1" style="width:38px;">
                        ...
                        <div class="form-group{{ $errors->has('position') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" id="position" name="position">
                                  ...
                                  <option class="" value="11">Staff</option>
                                  <option class="" value="2">Encoder</option>
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('branchID') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" id="branchID" name="branchID">
                                  ...
                                  <option class="" value="3">Manila</option>
                                </select>
