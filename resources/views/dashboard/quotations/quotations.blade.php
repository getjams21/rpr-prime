...
@section('content')
    ...
    <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Quotations Manipulation Panel
                    <small>View, add, edit or deactivate quotation options</small>
                </h1>
                <ol class="breadcrumb">
            ...
            <section class="content">
                @include('dashboard.quotations.view-items')
                <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12 shadowed"><br>
                            <div class="col-md-12 col-md-offset-0">
                                @include('dashboard.quotations.view')
                            </div>   
                        </div>
                    </div>
                </div><!-- /#container-fluid -->
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        var itemViewURL = '{{ route('itemViewURL') }}';
        var customerSearch = '{{ route('customerSearch') }}';
        var getItem = '{{ route('getItem') }}';
        var dealProject = '{{ route('dealProject') }}'
    </script>
    ...
    <script src="{{ asset ("/components/js/printThis.js") }}" type="text/javascript">
        </script>
@stop